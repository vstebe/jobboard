...
Rails.application.config.assets.precompile += %w( jobboard.css )
Rails.application.config.assets.precompile += %w( main-menu.js )
...
Rails.application.config.assets.precompile += %w( jobboard.js )